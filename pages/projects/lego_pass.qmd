...
![Calculated Shortest Path using UCS Algorithm](../../assets/lego_pass/lab1_navigate.png)

* 	visualize_path(coordinates) – Plots the computed path on a grid to visualize the planned trajectory.

![Drawn Path from Map ](../../assets/lego_pass/lab1_navigate2.png){height="350px"}
...
![Line Detection](../../assets/lego_pass/drawing_lines.png){height="350px"}
