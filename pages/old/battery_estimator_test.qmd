...
The battery model featured is incredibly simplified since it assumes a linear Open Current Voltage (VOC) vs. State of Charge (SOC) curves. But in reality, a wide variety of factors makes the "true" curve non-linear. 
